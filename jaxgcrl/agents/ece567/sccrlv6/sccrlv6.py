"""SCC-RL v6: v5 with the improvement filter removed entirely.

Keeps all v5 architectural fixes (critic calibration, temporal commitment,
active exploration) and stability fixes (log_var_h clamping, gradient
clipping) but trains the CVAE unconditionally on all replay buffer subgoals.
"""
...
@dataclass
class SCCRLV6:
    """SCC-RL v6: v5 without the improvement filter."""
